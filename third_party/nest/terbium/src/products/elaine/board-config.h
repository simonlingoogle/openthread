...
/* NRF invalid pin identifier*/
#define NRF_INVALID_GPIO 0xff
 ...
 */
#ifndef UART_PIN_CTS
#define UART_PIN_CTS NRF_INVALID_GPIO
#endif
 ...
 */
#ifndef UART_PIN_RTS
#define UART_PIN_RTS NRF_INVALID_GPIO
#endif
...
/**
 * @def PROJECT_FEM_ENABLE_DEFAULT_CONFIG
 *
 * Enable default front end module configuration.
 *
 */
#ifndef PROJECT_FEM_ENABLE_DEFAULT_CONFIG
#define PROJECT_FEM_ENABLE_DEFAULT_CONFIG 0
#endif
...
/*******************************************************************************
 * @section Radio driver interrupt priority configuration.
 ******************************************************************************/
/**
...
#define NRF_802154_IRQ_PRIORITY 2
#endif

/*******************************************************************************
 * @section Terbium driver configuration.
 ******************************************************************************/

/**
 * @def GPIO_IRQ_PRIORITY
 *
 * GPIO Interrupt priority.
 *
 * @note The coex module requires the Grant pin interrupt priority equals to the
 *       radio interrupt priority. The radio interrupt priority is 2. Here we set
 *       the GPIO interrupt priority to 2.
 *
 */
#ifndef GPIO_IRQ_PRIORITY
...
/*******************************************************************************
 * @section Watchdog RTC driver configuration.
 ******************************************************************************/
/**
 * @def WATCHDOG_RTC
 *
 ...
 */
#ifndef WATCHDOG_RTC
#define WATCHDOG_RTC NRF_RTC1
#endif

/**
 * @def WATCHDOG_RTC
 *
 * Watchdog RTC timer interrupt number.
 *
 */
#ifndef WATCHDOG_RTC_IRQN
#define WATCHDOG_RTC_IRQN RTC1_IRQn
#endif

/**
 * @def WATCHDOG_RTC
 *
 * Watchdog RTC timer interrupt handler name.
 *
 */
#ifndef WATCHDOG_RTC_IRQ_HANDLER
#define WATCHDOG_RTC_IRQ_HANDLER RTC1_IRQHandler
#endif

/**
 * @def WATCHDOG_RTC_IRQ_PRIORITY
 *
 * Watchdog RTC timer interrupt priority.
 *
 */
#ifndef WATCHDOG_RTC_IRQ_PRIORITY
#define WATCHDOG_RTC_IRQ_PRIORITY 0
#endif

/*
 * @def INTERRUPT_DISABLE_BASE_PRIORITY
 *
 * Interrupt priority for the BASEPRI.
 * When interrupts are disabled for critical sections,
 * we set the BASEPRI to mask off interrupts of this
 * priority and higher. So interrupts configured with
 * priority numbers less than this are never disabled
 * normally by drivers.
 *
 * Priorities we expect to use are:
 *  -3 Reset
 *  -2 NMI
 *  -1 Hard Fault
 *   0 RTC for watchdog
 ...
 *   4 unused
 *   5 unused
 *   6 regular interrupts
 */
#ifndef INTERRUPT_DISABLE_BASE_PRIORITY
#define INTERRUPT_DISABLE_BASE_PRIORITY 1
#endif

/**
 * @def INTERRUPT_DISABLE_BASE_PRIORITY_VALUE
 *
 * Base Priority register value. The format fefers to section B1.4.3 of
 * ARM v7-M Architecture Reference Manual.
 *
 */
#define INTERRUPT_DISABLE_BASE_PRIORITY_VALUE (INTERRUPT_DISABLE_BASE_PRIORITY << (8 - __NVIC_PRIO_BITS))
