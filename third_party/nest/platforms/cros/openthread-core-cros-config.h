...
#ifndef NET_WIRELESS_OPENTHREAD_FILES_INCLUDE_OPENTHREAD_CORE_CHROMEOS_CONFIG_H_
#define NET_WIRELESS_OPENTHREAD_FILES_INCLUDE_OPENTHREAD_CORE_CHROMEOS_CONFIG_H_
 ...
 *
 */
#define OPENTHREAD_CONFIG_PLATFORM_INFO "POSIX-APP-CROS"
